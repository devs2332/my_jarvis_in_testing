...
class Settings(BaseSettings):
    ...
    LLM_PROVIDER: str = "nvidia"  # "google", "groq", "mistral", "openrouter", "openai", "nvidia"
    STT_ENGINE: str = "groq"  # "local", "speechbrain", "groq"
    AUTONOMOUS_MODE: str = "OFF"

    # ── OpenAI / LLM Model Defaults ──────────────────────
    OPENAI_API_KEY: str = ""
