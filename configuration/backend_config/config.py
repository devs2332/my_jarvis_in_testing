# jarvis_ai/configuration/backend_config/config.py
import os
from pathlib import Path
from dotenv import load_dotenv

# BASE_DIR points to the project root (2 levels up from configuration/backend_config/)
...
MEMORY_FILE = str(BASE_DIR / "database" / "memory.json")
AUTONOMOUS_MODE = "OFF"

# ===== VECTOR DB CONFIG =====
VECTOR_DB_DIR = str(BASE_DIR / "database" / "vector_db")
